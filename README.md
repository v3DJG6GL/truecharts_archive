...
- ### Changelog:
	...
	- 2025.12.25 @ 08:55 PM CET:
		- Premium:
			- nextcloud: v32.0.1 --> v32.0.3
	- 2025.12.25 @ 01:46 AM CET:
		- Stable:
			- immich-new: v2.4.1.03 --> v2.4.1.04
	- 2025.12.25 @ 01:36 AM CET:
		- Stable:
			- lidarr: vrolling --> vrolling
			- prowlarr: vrolling --> vrolling
			- radarr: vrolling --> vrolling
			- sonarr: vrolling --> vrolling
	- 2025.12.25 @ 01:32 AM CET:
		- Stable:
			- immich-new: v2.4.1.2 --> v2.4.1.03
	...
	- 2025.12.23 @ 12:12 AM CET:
		- Premium:
			- traefik: v3.6.5.00 --> v3.6.5.01
	- 2025.12.23 @ 12:03 AM CET:
		- Premium:
			- traefik: v3.6.5 --> v3.6.5.00
	- 2025.12.20 @ 06:03 PM CET:
		- Stable:
			- jellystat: v1.1.6 --> v1.1.7
	...
	- 2025.12.17 @ 02:23 AM CET:
		- Stable:
			- local-ai: v3.8.0 --> v3.8.0.1
	...
	- 2025.11.08 @ 03:11 PM CET:
		- Premium:
			- nextcloud: v32.0.1 --> v32.0.1
	- 2025.11.08 @ 02:29 PM CET:
		- Premium:
			- traefik: v3.6.0 --> v3.5.4
	- 2025.11.08 @ 02:26 PM CET:
		- Premium:
			- nextcloud: v32.0.1 --> v32.0.1
	...
	- 2025.11.03 @ 03:22 PM CET:
		- Premium:
			- nextcloud: v32.2.2 --> v32.0.1
	...
	- 2025.11.03 @ 02:33 PM CET:
		- Stable:
			- adguard-home: v0.107.67 --> v0.107.69
			- adguardhome-sync: v0.8.1 --> v0.8.2
			- anonaddy: v1.3.3 --> v1.3.5
			- apt-cacher-ng: v3.7.4 --> vlatest
			- atuin: v18.8.0 --> v18.10.0
			- authentik: v2025.8.4 --> v2025.10.0
			- automatic-ripping-machine: v2.20.5 --> v2.20.6
			- borg-server: v2.6.18 --> v2.6.20
			- calibre: v8.12.0 --> v8.13.0
			- changedetection-io: v0.50.23 --> v0.50.38
			- chroma: v1.1.1 --> v1.3.0
			- clamav: v1.5.0 --> v1.5.1
			- clickhouse: v25.9.3.48 --> v25.10.1.3832
			- cloudflared: v2025.9.1 --> v2025.10.1
			- cloudreve: v4.8.0 --> v4.9.2
			- code-server: v4.104.3 --> v4.105.1
			- collabora: v25.04.6.1.1 --> v25.04.6.2.1
			- crafty-4: v4.5.4 --> v4.5.5
			- ddns-go: v6.12.5 --> v6.13.2
			- deconz: v2.31.2 --> v2.32.0
			- digikam: v8.7.0 --> v8.8.0
			- drawio: v28.2.5 --> v28.2.9
			- ersatztv: v25.7.1 --> v25.8.0
			- esphome: v2025.9.3 --> v2025.10.3
			- filebrowser: v2.44.0 --> v2.45.0
			- flaresolverr: v3.4.2 --> v3.4.3
			- flexget: v3.18.14 --> v3.18.20
			- flood: v4.10.0 --> v4.11.0
			- frigate: v0.16.1 --> v0.16.2
			- gamevault-backend: v16.0.1 --> v16.1.1
			- ghostfolio: v2.208.0 --> v2.214.0
			- gitea: v1.24.6 --> v1.25.0
			- grav: v1.7.49 --> v1.7.50
			- gravity: v0.28.1 --> v0.28.7
			- handbrake: v25.09.2 --> v25.10.1
			- homarr: v0.16.0 --> v1.43.1
			- home-assistant: v2025.10.2 --> v2025.10.4
			- immich: v2.0.1 --> v2.2.2
			- immich-new: v2.0.1 --> v2.2.2
			- ipfs: v0.38.1 --> v0.38.2
			- ispy-agent-dvr: v6.6.6.0 --> v6.8.4.0
			- jackett: v0.24.124 --> v0.24.244
			- jenkins: v2.531.0 --> v2.534.0
			- kanboard: v1.2.47 --> v1.2.49
			- kasm: v1.17.0 --> v1.18.0
			- kavita: v0.8.7 --> v0.8.8
			- kiwix-serve: v3.7.0 --> v3.8.0
			- kopia: v20251008.0.52618 --> v20251023.0.52914
			- lidarr: v2.14.5 --> v3.0.1
			- lidarr-plugins: v2.14.5.4825 --> v3.0.0.485
			- linkwarden: v2.13.0 --> v2.13.1
			- local-ai: v3.6.0 --> v3.7.0
			- maintainerr: v2.19.0 --> v2.20.0
			- matomo: v5.5.0 --> v5.5.1
			- mealie: v3.3.2 --> v3.4.0
			- medusa: v1.0.22 --> v1.0.24
			- meshcentral: v1.1.51 --> v1.1.53
			- metabase: v0.56.9 --> v0.56.12
			- metube: v2025.10.01 --> v2025.10.23
			- minecraft-java: v2025.10.2 --> v2025.10.5
			- miniflux: v2.2.13 --> v2.2.14
			- misskey: v2025.10.0 --> v2025.10.2
			- mysql-workbench: v8.0.43 --> v8.0.44
			- n8n: v1.116.0 --> v1.119.0
			- netdata: v2.7.0 --> v2.7.3
			- notifiarr: v0.8.3 --> v0.9.0
			- ollama: v0.12.5 --> v0.12.9
			- onlyoffice-document-server: v9.0.4 --> v9.1.0
			- openhab: v5.0.1 --> v5.0.2
			- openvscode-server: v1.103.1 --> v1.105.1
			- oscam: v11890.0.0 --> v11903.0.0
			- outline: v0.87.4 --> v1.0.1
			- paperless-ngx: v2.18.4 --> v2.19.3
			- pgadmin: v9.8.0 --> v9.9.0
			- phpmyadmin: v5.2.2 --> v5.2.3
			- pihole: v2025.08.0 --> v2025.10.3
			- piwigo: v15.6.0 --> v15.7.0
			- plextraktsync: v0.34.15 --> v0.34.16
			- pocketmine-mp: v5.35.0 --> v5.37.0
			- portainer: v2.34.0 --> v2.35.0
			- prowlarr: v2.1.3.5208 --> v2.1.5.5216
			- proxmox-backup-server: v4.0.13 --> v4.0.18
			- qbitrr: v4.10.24 --> v5.2.0
			- radarr: v6.0.2.10271 --> v6.0.3.10276
			- rdtclient: v2.0.118 --> v2.0.119
			- redmine: v6.0.6 --> v6.1.0
			- rstudio: v4.5.1 --> v4.5.2
			- sabnzbd: v4.5.3 --> v4.5.5
			- seafile: v13.0.11 --> v13.0.12
			- sftpgo: v2.6.6 --> v2.7.0
			- shlink: v4.5.3 --> v4.6.0
			- slink: v1.7.3 --> v1.7.5
			- sonarr: v4.0.15.2940 --> v4.0.16.2942
			- sourcegraph: v6.8.2313 --> v6.9.2509
			- speedtest-tracker: v1.6.8 --> v1.6.11
			- stash: v0.28.1 --> v0.29.1
			- static-web-server: v2.38.1 --> v2.39.0
			- strapi: v5.24.1 --> v5.30.0
			- syslog-ng: v4.10.1 --> v4.10.2
			- tailscale: v1.88.3 --> v1.90.6
			- tandoor-recipes: v2.3.2 --> v2.3.3
			- tasmoadmin: v4.3.1 --> v4.3.2
			- tdarr: v2.49.01 --> v2.51.03
			- tdarr-node: v2.49.01 --> v2.51.03
			- theme-park: v1.21.2 --> v1.21.3
			- tinymediamanager: v5.2.2 --> v5.2.3
			- unifi: v9.4.19 --> v9.5.21
			- uptime-kuma: v1.23.16 --> v1.23.17
			- wallos: v4.4.1 --> v4.5.0
			- wekan: v7.99.0 --> v8.16.0
			- whisparr: v3.0.1.1310 --> v3.0.1.1327
			- wizarr: v2025.9.1 --> v2025.10.8
			- wyoming-openwakeword: v1.10.0 --> v2.1.0
			- xen-orchestra: v5.190.1 --> v5.192.0
			- xwiki: v17.8.0 --> v17.9.0
			- zigbee2mqtt: v2.6.2 --> v2.6.3
			- zwavejs2mqtt: v11.4.1 --> v11.6.1
		- Premium:
			- traefik: v3.5.3 --> v3.5.4
	- 2025.10.14 @ 02:30 AM CEST:
		- Stable:
			- ollama: v0.12.3 --> v0.12.5
		- Premium:
			- authelia: v4.39.12 --> v4.39.13
